...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // EvaCoin is not connected
...
/**
 * EvaCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern json_spirit::Value getnextdifficulty(const json_spirit::Array& params, bool fHelp);
std::string rfcTime(boost::uint64_t bTime);
